...
export default function RentalCard({ parcel }) {
    const stateMap = {
        certified: {
            title: 'Rental Status: Certified Lead Safe',
            message: (
                <div className={styles.messageBox}>
                    <h3>This property is registered as a rental with the City of Cleveland and is certified safe from lead contamination.</h3>
                </div>
            ),
            icon: (
        ...
        nonCompliance: {
            title: 'Rental Status: Out Of Compliance',
            message: (
                <div className={styles.messageBox}>
        ...
        unknown: {
            title: 'Rental Status: Not A Known Rental',
            message: (
                <div className={styles.messageBox}>
