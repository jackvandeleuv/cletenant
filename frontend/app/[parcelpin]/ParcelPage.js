...
export default function ParcelPage({ parcel }) {    
    ...
    const enforcement = [
        ['Civil Tickets', parcel.civil_tickets, 'civil-tickets'],
        ['Code Violations', parcel.code_violations, 'violations'],
        ['311 Complaints', parcel.complaints_311, 'complaints-311'],
        ['Health Complaints', parcel.complaints_health, 'complaints-health'],
    ];
